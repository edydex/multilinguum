...
- The live transcriber normally closes a recognition window every 3.5 seconds and can close sooner after 360 ms of detected mixer silence. Expressive speech still buffers coherent clauses, but a real preacher pause can end a clause early; a bounded portion of that pause is retained in the translated program while synthetic provider padding is removed.
